  ...
  const listItemView = (item) => {
    ...
    return (
      <View key={item.id} style={styles.formContainer}>
        <Text style={styles.title2}>Informacion del Tratamiento:</Text>
        <View style={styles.userInfoContainer}>
          <MyText textValue="Nombre del Usuario:" textStyle={styles.title} />
          <MyText textValue={item.users} textStyle={styles.textStyle} />
        </View>
        <View style={styles.userInfoContainer}>
          <MyText textValue="Identificación:" textStyle={styles.title} />
          <MyText textValue={item.identificacion} textStyle={styles.textStyle} />
        </View>
        <View style={styles.userInfoContainer}>
          <MyText textValue="Fecha de inicio:" textStyle={styles.title} />
          <MyText textValue={item.fechaInicio} textStyle={styles.textStyle} />
        </View>
        <View style={styles.userInfoContainer}>
          <MyText textValue="Observaciones:" textStyle={styles.title} />
          {item.observaciones ? (
            <MyText textValue={item.observaciones} textStyle={styles.textStyle} />
          ) : (
            <MyText textValue="No hay observaciones" textStyle={styles.textStyle} />
          )}
        </View>
